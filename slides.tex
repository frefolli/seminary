...
\begin{frame}
  ...
  \begin{block}{Operation}
    \begin{itemize}
      ...
      \item Traverse the CSTs to capture the components definitions and the references
      \item Construct a \textit{Language-Independent} \textbf{Component Tree}
      \item Accumulate the \textbf{Dependency Queries}
      \item Resolve the Dependency Queries with the Component Tree into the \textbf{Dependency Graph}
  ...
  \begin{columns}
    \begin{column}{0.50\textwidth}
      ...
      \begin{adjustbox}{width=\textwidth,keepaspectratio}
        \lstinputlisting[language=Rust]{listings/approach/cst-traversal/translation/java.txt}
      \end{adjustbox}
    \end{column}
    \begin{column}{0.50\textwidth}
      \center
      \textbf{Rust}
      \begin{adjustbox}{width=\textwidth,keepaspectratio}
        \lstinputlisting[language=Rust]{listings/approach/cst-traversal/translation/rust.txt}
      \end{adjustbox}
    \end{column}
  \end{columns}
  \begin{columns}
    \begin{column}{0.50\textwidth}
      ...
      \textbf{C++}
      \begin{adjustbox}{width=\textwidth,keepaspectratio}
        \lstinputlisting[language=Rust]{listings/approach/cst-traversal/translation/cpp.txt}
      \end{adjustbox}
    \end{column}
    \begin{column}{0.50\textwidth}
      \center
      \textbf{Python}
      \begin{adjustbox}{width=\textwidth,keepaspectratio}
        \lstinputlisting[language=Rust]{listings/approach/cst-traversal/translation/python.txt}
      \end{adjustbox}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{center}
      ...
      \begin{adjustbox}{width=\textwidth,keepaspectratio}
        \lstinputlisting[language=Rust]{listings/approach/cst-traversal/generalization/java-rust-python.txt}
      \end{adjustbox}

      \textbf{C / C++}
      \begin{adjustbox}{width=\textwidth,keepaspectratio}
        \lstinputlisting[language=Rust]{listings/approach/cst-traversal/generalization/cpp.txt}
      \end{adjustbox}
  \end{center}
\end{frame}
...
\begin{frame}
  \frametitle{Shenanigans / Ghost Nodes}
\end{frame}

\begin{frame}
  \frametitle{Shenanigans / Operator Overloading}
\end{frame}

\begin{frame}
  \frametitle{Shenanigans / Deref Trait}
\end{frame}
