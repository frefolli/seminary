...
\lstdefinestyle{tscst}{
  ...
  showstringspaces=false,
  keywordstyle=\bfseries\color{green!40!black},
  morekeywords={type:, name:, parameters:, declarator:, body:, return_type:},
  identifierstyle=\color{blue},
  stringstyle=\color{orange},        
  alsoletter={-},
  alsodigit={:}
...
\author[Francesco~Refolli]{\textbf{Francesco~Refolli} \and ~Luca~Teruzzi}
...
\begin{frame}
  ...
  \begin{block}{Development}
    \begin{itemize}
      \item Gain initial knowledge of a language's \textbf{grammar}
      \item Gain initial knowledge of a language's \textbf{semantics}
      \item Prepare a \textbf{language benchmark} to verify that the implementation is correct
      \item Each programming language shall be described as a \textbf{feature set}
    \end{itemize}
  \end{block}

  \begin{block}{Operation}
    \begin{itemize}
      \item Extract CSTs with \textbf{Tree Sitter} for each file
      \item \textcolor{ATMRed}{Traverse the CSTs to capture the components definitions and the references}
      \item \textcolor{ATMRed}{Construct a \textit{Language-Independent} \textbf{Component Tree}}
      \item \textcolor{ATMRed}{Accumulate the \textbf{Dependency Queries}}
      \item \textcolor{ATMGreen}{Resolve the Dependency Queries with the Component Tree into the \textbf{Dependency Graph}}
      \item Export the Dependency Graph to JSON
    \end{itemize}
  \end{block}
\end{frame}

\begin{frame}[fragile]
  \frametitle{How it works / CST Traversal / Analysis}
  \begin{columns}
    \begin{column}{0.50\textwidth}
      \center
      \textbf{Java}
      \lstinputlisting[style=tscst]{listings/approach/cst-traversal/analysis/java.txt}
    \end{column}
    \begin{column}{0.50\textwidth}
      \center
      \textbf{Rust}
      \lstinputlisting[style=tscst]{listings/approach/cst-traversal/analysis/rust.txt}
    \end{column}
  \end{columns}
  \begin{columns}
    \begin{column}{0.50\textwidth}
      \center
      \textbf{C++}
      \lstinputlisting[style=tscst]{listings/approach/cst-traversal/analysis/cpp.txt}
    \end{column}
    \begin{column}{0.50\textwidth}
      \center
      \textbf{Python}
      \lstinputlisting[style=tscst]{listings/approach/cst-traversal/analysis/python.txt}
    \end{column}
  \end{columns}
\end{frame}

\begin{frame}[fragile]
  \frametitle{How it works / CST Traversal / Translation}
  \begin{columns}
    \begin{column}{0.50\textwidth}
      \center
      \textbf{Java}
      \begin{figure}
        \begin{center}
          \includegraphics[width=1.0\textwidth]{figures/approach/cst-traversal/translation/java.png}
        \end{center}
      \end{figure}
    \end{column}
    \begin{column}{0.50\textwidth}
      ...
      \begin{figure}
        \begin{center}
          \includegraphics[width=1.0\textwidth]{figures/approach/cst-traversal/translation/rust.png}
        \end{center}
      \end{figure}
    \end{column}
  \end{columns}
  \begin{columns}
    \begin{column}{0.50\textwidth}
      ...
      \begin{figure}
        \begin{center}
          \includegraphics[width=1.0\textwidth]{figures/approach/cst-traversal/translation/cpp.png}
        \end{center}
      \end{figure}
    \end{column}
    \begin{column}{0.50\textwidth}
      ...
      \begin{figure}
        \begin{center}
          \includegraphics[width=1.0\textwidth]{figures/approach/cst-traversal/translation/python.png}
        \end{center}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}[fragile]
  \frametitle{How it works / CST Traversal / Generalization}
  \begin{center}
      \textbf{Java / Rust / Python}
      \begin{figure}
        \begin{center}
          \includegraphics[width=1.0\textwidth]{figures/approach/cst-traversal/generalization/java-rust-python.png}
        \end{center}
      \end{figure}
      ...
      \begin{figure}
        \begin{center}
          \includegraphics[width=1.0\textwidth]{figures/approach/cst-traversal/generalization/cpp.png}
        \end{center}
      \end{figure}
  \end{center}
\end{frame}
...
\begin{frame}
  \frametitle{How it works / Dependency Resolution / Identifier Chains}
  \begin{figure}
    \begin{center}
      \includegraphics[width=0.7\textwidth]{figures/approach/dependency-resolution/identifier-chains/component-graph.png}
    \end{center}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.40\textwidth}
      \begin{figure}
        \begin{center}
          \includegraphics[width=1.0\textwidth]{figures/approach/dependency-resolution/identifier-chains/component-graph.png}
        \end{center}
      \end{figure}
    \end{column}
    \begin{column}{0.60\textwidth}
      \begin{block}{}
        ...
        \begin{adjustbox}{width=\textwidth,keepaspectratio}
          \lstinputlisting[language=Python]{listings/approach/dependency-resolution/identifer-chains/resolve.py}
        \end{adjustbox}
      \end{block}
      ...
      \begin{block}{}
        \center
        \begin{adjustbox}{width=\textwidth,keepaspectratio}
          \lstinputlisting[language=Python]{listings/approach/dependency-resolution/identifer-chains/going-up.py}
        \end{adjustbox}
      \end{block}
      ...
      \begin{block}{}
        \center
        \begin{adjustbox}{width=\textwidth,keepaspectratio}
          \lstinputlisting[language=Python]{listings/approach/dependency-resolution/identifer-chains/going-down.py}
        \end{adjustbox}
      \end{block}
    \end{column}
  \end{columns}
...
\begin{frame}
  \frametitle{How it works / Dependency Resolution / Type Resolution}
  \center
  \begin{figure}
    \begin{center}
      \includegraphics[width=0.8\textwidth]{figures/approach/dependency-resolution/type-resolution/component-graph.png}
    \end{center}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.40\textwidth}
      \begin{figure}
        \begin{center}
          \includegraphics[width=1.0\textwidth]{figures/approach/dependency-resolution/type-resolution/component-graph.png}
        \end{center}
      \end{figure}
    \end{column}
    \begin{column}{0.60\textwidth}
      \begin{block}{}
        \center
        \begin{adjustbox}{width=\textwidth,keepaspectratio}
          \lstinputlisting[language=Python]{listings/approach/dependency-resolution/type-resolution/resolve.py}
        \end{adjustbox}
      \end{block}
    \end{column}
  \end{columns}
...
\begin{frame}
  \frametitle{How it cheats / Ghost Nodes}
  \begin{alertblock}{Problem}
    \begin{itemize}
      \item Code definitions are caught through CST traversal
      \item References can be solved iff both source and target are on the graph
      \item TPL's components cannot be detected because their code isn't read
      \item References TPL's components cannot be detected because they aren't on the graph
    \end{itemize}
  \end{alertblock}
  \begin{block}{Example}
    %\begin{adjustbox}{width=\textwidth,keepaspectratio}
      \center
      \lstinputlisting[language=Java]{listings/approach/cheating/ghost-nodes.java}
    %\end{adjustbox}
  \end{block}
  \begin{exampleblock}{Solution}
    \begin{itemize}
      \item Every time we should find a component but nothing is there
      \item Ex: a method 'foo' inside class 'FoursquareApi' which isn't there
      \item Create a 'ghost' node with volatile a kind so that we can decided what to do
    \end{itemize}
  \end{exampleblock}
\end{frame}

\begin{frame}
  \frametitle{How it cheats / Operator Overloading}
  \begin{alertblock}{Problem}
    \begin{itemize}
      \item Some programming languages allow operator overloading
      \item Syntactically, these are treated as binary/monary operators
      \item Overloaded operators carry complex logic
    \end{itemize}
  \end{alertblock}
  \begin{block}{Example}
    \center
    \begin{adjustbox}{width=0.8\textwidth,keepaspectratio}
      \lstinputlisting[language=C++]{listings/approach/cheating/operator-overloading.cc}
    \end{adjustbox}
  \end{block}
  \begin{exampleblock}{Solution}
    \begin{itemize}
      \item Usually, programming languages define overloading as methods
      \item We can intercept those method definitions knowing their encoded name
      \item We can guess their name since they usually have a naming schema
      \item This data can be added to the language feature set
    \end{itemize}
  \end{exampleblock}
\end{frame}

\begin{frame}
  \frametitle{How it cheats / Deref Trait}
  \begin{alertblock}{Problem}
    \begin{itemize}
      \item Rust and other languages allow definitions of Delegate Operands
      \item These delegates are not defined as parent classes or target of implementations
      \item Languages don't offer clear indicators at component definition level
    \end{itemize}
  \end{alertblock}
  \begin{block}{Example}
    %\begin{adjustbox}{width=\textwidth,keepaspectratio}
      \center
      \lstinputlisting[language=Rust]{listings/approach/cheating/defer-trait.rs}
    %\end{adjustbox}
  \end{block}
  \begin{exampleblock}{Solution}
    \begin{itemize}
      \item Usually these are implemented as methods or attributes
      \item Knowing how they are named, we can intercept them
    \end{itemize}
  \end{exampleblock}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \begin{center}
      \includegraphics[width=1.0\textwidth]{figures/testing/comparison-graphs.png}
    \end{center}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \begin{center}
      \includegraphics[width=0.9\textwidth]{figures/testing/comparison-times.png}
    \end{center}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{alertblock}{Functional Problems}
    \begin{itemize}
      \item Package name detection is not working properly
      \item Multi-crate projects are not supported
      \item Traits are not fully supported
      \item Generics are not supported
    \end{itemize}
  \end{alertblock}

  \begin{block}{Structural Problems}
    \begin{itemize}
      \item The prototype is exploratory, with readability issues due to inexperience
      \item Early work hinders future progress and will need a full rewrite
      \item Caching and multithreading are missing
      \item The graph includes debug fields and doesn't handle duplicate dependencies
      \item File discovery is not properly handled
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Consequences}
    \begin{itemize}
      \item The prototype was an exploratory artifact, answering to a specific research question: "is it possible?"
      \item As such it has accomplished its purpose: "now it can be trashed"
      \item More work shall be done in order to get an usable framework
    \end{itemize}
  \end{block}

  \begin{exampleblock}{Research Path}
    \begin{itemize}
      \item Formalize the approach (and maybe prove its correctness)
      \item Design an implementation scheme in advance
      \item Rewrite the prototype into its 3rd iteration
    \end{itemize}
  \end{exampleblock}
\end{frame}
